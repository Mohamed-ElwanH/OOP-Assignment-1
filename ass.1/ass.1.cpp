...
{                                                                               //                 ||
    int choice;                                                                 //                \  /
                                                                                //                 \/
    vector<string> choices = {"1-Load a new image", "2-GrayScale filter", "3-BlackAndWhite filter", "4-Flip Image Horizontally", "5-Flip Image Vertically", "6-Crop image", "7-Adjust brightness", "8-Exit"};
    cout << "Choose" << endl;
